...
var author$project$Grubi$main = elm$browser$Browser$sandbox(
	{init: author$project$Grubi$initialModel, update: author$project$Grubi$update, view: author$project$Grubi$view});
