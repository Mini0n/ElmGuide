...
var author$project$Grubi$GetSelectIndex = function (a) {
	return {$: 'GetSelectIndex', a: a};
};
...
var author$project$Grubi$thumbArray = elm$core$Array$fromList(author$project$Grubi$initialModel.thumbs);
...
var author$project$Grubi$getThumbURL = function (index) {
	var _n0 = A2(elm$core$Array$get, index, author$project$Grubi$thumbArray);
	if (_n0.$ === 'Just') {
		var thumb = _n0.a;
		return thumb.url;
	} else {
...
var author$project$Grubi$randomPhotoPicker = A2(
	elm$random$Random$int,
	0,
	elm$core$Array$length(author$project$Grubi$thumbArray) - 1);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SelectRandom':
				return _Utils_Tuple2(
					model,
					A2(elm$random$Random$generate, author$project$Grubi$GetSelectIndex, author$project$Grubi$randomPhotoPicker));
			case 'SelectSize':
				var size = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selected: author$project$Grubi$getThumbURL(index)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
